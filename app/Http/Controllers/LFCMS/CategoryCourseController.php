...
use App\Models\LFCMS\CategoryCourse;
...
class CategoryCourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lfcms.pages.kursus.kategori-kursus.index', compact('categories', 'categoryNames'));
    }

    public function create()
    {
      $categories = CategoryCourse::with('users')->get();
      return view('lfcms.pages.kursus.kategori-kursus.create', compact('categories'));
    }
