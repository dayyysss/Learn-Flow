...
<head>
    ...
    <title>@yield('page_title', '403 | Forbidden')</title>
    ...
    <section>
        <div class="container py-100px">
            <div class="w-full lg:max-w-770px lg:mx-auto text-center">
                <img src="{{ asset('assets/images/icon/error_403.png') }}" alt="" class="w-full mb-60px">
                <h3
                ...
                <p class="text-lg text-contentColor dark:text-contentColor-dark leading-22px">
                    The page you are looking for is forbidden. You don't have permission to view this page.
                </p>
                <div class="mt-50px text-center">
                    <a href="javascript:void(0);" onclick="window.history.back();"
                        ...
                        Back To Previous Page <i class="icofont-simple-right"></i>
                    </a>
                </div>
            </div>
        </div>
