...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 invisible transition-opacity duration-300 z-[-1]">
    <div class="modal-content bg-whiteColor dark:bg-whiteColor-dark shadow-accordion dark:shadow-accordion-dark rounded-5 p-6 relative w-full max-w-lg transform -translate-y-12 transition-transform duration-300">
        <h2 id="modalTitle" class="text-xl font-semibold text-blackColor dark:text-whiteColor mb-4">Edit Kategori Kursus</h2>
        ...
        <form id="categoryForm" method="POST">
            ...
            <button type="submit" class="w-full text-size-12 2xl:text-size-15 text-whiteColor bg-primaryColor block border-primaryColor border hover:text-primaryColor hover:bg-white px-15px py-2 rounded-standard dark:hover:bg-whiteColor-dark dark:hover:text-whiteColor">Update</button>
        </form>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Trigger Edit Modal when clicking the edit button
        ...
        // Update slug dynamically as name input changes
        ...
        // Close Modal
        const closeModal = document.querySelector('label[for="modalToggleEdit"]');
