                ...
                <div class="tab-links flex flex-wrap mb-10px lg:mb-50px rounded gap-10px">
                    ...
                    @if (auth()->user()->role_id != 3)
                        <button id="addReviewBtn" onclick="openModal()"
                            class="hidden is-checked relative py-10px px-5 md:py-15px lg:px-10 font-bold uppercase text-sm lg:text-base text-blackColor bg-whiteColor shadow-overview-button dark:bg-whiteColor-dark dark:text-blackColor-dark before:w-0 before:h-0.5 before:absolute before:-bottom-0.5 lg:before:bottom-0 before:left-0 before:bg-primaryColor hover:before:w-full before:transition-all before:duration-300 whitespace-nowrap ml-auto">
                            Tambah Ulasan
                        </button>
                    @endif
