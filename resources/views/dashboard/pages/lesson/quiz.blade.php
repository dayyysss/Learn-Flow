        ...
        @foreach ($quizzes->questions as $question)
                ...
                <ul>
                    @foreach ($question->options as $option)
                        <li><input class="form-control" id="option-a-{{ $option->id }}" name="option" type="radio" />
                            <label for="option-a-{{ $option->id }}"> {{ $option->option_a }}</label></li>
                        <li><input class="form-control" id="option-b-{{ $option->id }}" name="option" type="radio" />
                            <label for="option-b-{{ $option->id }}">{{ $option->option_b }}</label></li>
                        <li><input class="form-control" id="option-c-{{ $option->id }}" name="option" type="radio" />
                            <label for="option-c-{{ $option->id }}">{{ $option->option_c }}</label>
                        </li>
                        <li><input class="form-control" id="option-d-{{ $option->id }}" name="option" type="radio" />
                            <label for="option-d-{{ $option->id }}">{{ $option->option_d }}</label>
                        </li>
                        <li><input class="form-control" id="option-e-{{ $option->id }}" name="option" type="radio" />
