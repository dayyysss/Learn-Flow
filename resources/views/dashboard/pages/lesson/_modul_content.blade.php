    ...
    <div class="modul" id="modul">
        <div class="pr-5" style="padding-bottom: 12%">
            ...
            <div class="flex modul-task gap-30px">
                ...
                <div class="modul-isi" id="modul-isi">
                    <!-- Video Modul -->
                    <div
                        class="dark:bg-lightGrey10-dark flex justify-center relative z-0 overflow-y-visible 2xl:pb-150px 2xl:pt-40.5">
                        @if ($modul->video)
                            <!-- Cek apakah ada video -->
                            <div class="w-full py-18px flex justify-center">
                                <iframe
                                    @if (filter_var($modul->video, FILTER_VALIDATE_URL)) @if (strpos($modul->video, 'youtube.com/watch?v=') !== false)
                        ...
                        @else
                            src="{{ $modul->video }}" @endif
                                @else src="{{ asset('storage/' . $modul->video) }}" @endif
                                    allowfullscreen=""
...
@endif --}}
    ...
    <style>
        ...
        .modul-isi {
            flex-grow: 1;
            /* Modul mengambil sisa ruang yang tersedia */
            min-width: 0;
            /* Mencegah elemen meluap */
        }

        .task {
            width: 300px;
            /* Lebar tetap untuk submission */
            flex-shrink: 0;
            /* Tidak mengecil */
