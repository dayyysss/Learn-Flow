            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-30px">
                ...
                <div class="xl:col-start-5 xl:col-span-8 relative" data-aos="fade-up">
                    <div data-aos="fade-up" class="2xl:ml-65px">
                        ...
                        <p class="flex items-center gap-x-4 text-lg text-blackColor dark:text-blackColor-dark mb-15px">
                            <img loading="lazy" src="assets/images/about/about_15.png" alt="about">
                            <span><b>10+ Years ExperienceIn</b> this game, Means Product
                                Designing</span>
                        </p>
                        <p class="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-15px">
