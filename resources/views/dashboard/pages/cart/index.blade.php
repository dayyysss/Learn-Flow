            ...
            <tbody>
                @foreach ($carts as $cart)
                            @foreach ($cart->cartItems as $item)
                                        ...
                                        @endphp
                                        <tr class="border-b border-borderColor dark:border-borderColor-dark" id="cart-item-{{ $cart->id }}">
                                            <td class="py-15px md:py-5 border-r border-borderColor dark:border-borderColor-dark"
                                                style="display: flex; justify-content: center; align-items: center;">
                                                <img src="{{ asset('storage/' . $course->thumbnail) }}" alt="{{ $course->name }}" width="60">
                                            </td>
                                            <td class="py-15px md:py-5 border-r border-borderColor dark:border-borderColor-dark">
                                                <a class="hover:text-primaryColor" href="product-details.html" id="course-name-{{ $cart->id }}">
