                    ...
                    <div class="tab-content-wrapper" data-aos="fade-up">
                      ...
                      >
                        ...
                        <div class="relative mb-4">
                          <a
                            href="{{route('course.detail', $item_publik->slug)}}"
                            class="w-full overflow-hidden rounded"
                          >
                            <img
                              src="{{ asset('storage/' . $item_publik->thumbnail) }}"
                              alt=""
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                              ...
                              <div>
                                <span
                                  ...
                                  >{{$item_publik->tanggal_mulai}}</span
                                >
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="text-lg font-semibold text-primaryColor font-inter mb-4">
                            @if($item_publik->harga_diskon)
                                ...
                                Rp {{ number_format($item_publik->harga - $item_publik->harga_diskon, 2, ',', '.') }}
                            ...
                            <span class="ml-6">
                                @if($item_publik->harga - $item_publik->harga_diskon > 0) <!-- Jika harga setelah diskon lebih besar dari nol -->
