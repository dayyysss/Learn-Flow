...
@section('content')
    ...
    <div class="container mx-auto py-10 px-4">
        ...
        <!-- Main Form Container -->
        <button
            class="btn px-2 py-1 bg-primaryColor text-white rounded-md mb-5 b-light btn-primary-light dk-theme-card-square"
            id="openModal">
                        ...
                        <div class="bg-whiteColor dark:bg-whiteColor-dark shadow-accordion dark:shadow-accordion-dark">
                            <div class="py-5 px-30px">
                                <div
                                    ...
                                    <div class="flex items-center gap-1 space-x-2">
                                        {{-- Tombol tambah modul --}}
                                        <button
                                            class="btn px-2 py-2 border rounded-full b-light btn-primary-light dk-theme-card-square openModalTambahModul"
                                    ...
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        @if ($bab->moduls->isNotEmpty())
                                            <div class="btn px-2 py-2 border rounded-full b-light bg-blue btn-primary-light dk-theme-card-square"
                                                style="color: #0c63e4">
                                                <svg class="transition-all text-white duration-500 rotate-0" width="15"
                            ...
                            <div class="accordion-content transition-all duration-500 overflow-hidden h-0">
                                <div class="content-wrapper py-4 px-5">
                                    <div class="bab-form bg-darkdeep3 dark:bg-transparent text-sm text-blackColor dark:text-blackColor-dark leading-1.8"
                                        data-aos="fade-up" id="video-form">
                                            ...
                                            <div class="border">
                                                @foreach ($bab->moduls as $modul)
                                                    <div class="flex border-b justify-between border-gray-300 py-2 px-4">
                                                        ...
                                                        <div>
                                                            <a
                                                                href="{{ route('modul.detail.admin', ['course' => $course->slug, 'modul' => $modul->slug]) }}">Detail
                                                                >></a>
                                                        </div>
                                                    </div>
                                                @endforeach
