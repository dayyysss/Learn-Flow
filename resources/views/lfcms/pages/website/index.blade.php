                            ...
                            <div class="grid gap-x-4 gap-y-5">
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <input type="text" id="nama_perusahaan" name="nama_perusahaan"
                                        value="{{ $configuration->nama_perusahaan ?? '-' }}" class="form-input">
                                </div>
                                <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                                    <div class="col-span-full xl:col-auto leading-none">
                                        <label for="judul_website" class="form-label">Nama Website</label>
                                        <input type="text" id="judul_website" name="judul_website"
                                            value="{{ $configuration->judul_website ?? '-' }}" class="form-input">
                                    </div>
                                    <div class="col-span-full xl:col-auto leading-none">
                                        <label for="nama_domain" class="form-label">Nama Domain</label>
                                        <input type="text" id="nama_domain" name="nama_domain"
                                            value="{{ $configuration->nama_domain ?? '-' }}" class="form-input">
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <input type="text" id="alamat" name="alamat"
                                        value="{{ $configuration->alamat ?? '-' }}" class="form-input">
                                </div>
            ...
            <div class="col-span-full sm:col-span-6 xl:col-span-4 card p-0">
                <div class="bg-white dark:bg-dark-card rounded-15 overflow-hidden dk-theme-card-square">
                    <div class="relative w-full h-[150px]">
                        <img src="{{ asset('assets/lfcms/images/profile/cover.png') }}" alt="cover-image"
                            class="w-full h-full">
                    ...
                    <div class="mt-7 px-6 text-center">
                        ...
                        <div class="py-5 border-t border-gray-200 dark:border-dark-border text-left">
                            <div class="flex-center-between">
                                ...
                                <button class="size-7 hover:bg-gray-200 dark:hover:bg-dark-icon rounded-md"
                                    data-modal-target="addKeyword" data-modal-toggle="addKeyword">
                        ...
                        <div class="py-5 border-t border-gray-200 dark:border-dark-border text-left">
                            <div class="flex-center-between">
                                ...
                                <button class="size-7 hover:bg-gray-200 dark:hover:bg-dark-icon rounded-md"
                                    data-modal-target="addKontak" data-modal-toggle="addKontak">
                                    <i class="ri-edit-2-line"></i>
                                </button>
                            </div>
                            <ul
                                ...
                                @if (!empty($configuration->informasi_kontak) && is_array(json_decode($configuration->informasi_kontak, true)))
                                    @foreach (json_decode($configuration->informasi_kontak, true) as $contact)
                                        <li class="flex items-center gap-x-2.5">
                                            ...
                                            @endif
                                            <div>{{ $contact['name'] }}: <span
                                                    class="text-heading dark:text-dark-text">{{ $contact['value'] }}</span>
                                            </div>
                                        </li>
                                    @endforeach
                                @endif
                        ...
                        <div class="py-5 border-t border-gray-200 dark:border-dark-border text-left">
                            <div class="flex-center-between">
                                ...
                                <button class="size-7 hover:bg-gray-200 dark:hover:bg-dark-icon rounded-md"
                                    data-modal-target="addSosmed" data-modal-toggle="addSosmed">
                                    <i class="ri-edit-2-line"></i>
                                </button>
                            </div>
                            <ul
