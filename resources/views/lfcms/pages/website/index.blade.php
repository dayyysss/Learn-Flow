...
@section('content')
            ...
            <div class="col-span-full sm:col-span-6 xl:col-span-8">
                ...
                <div class="card p-0 overflow-hidden mb-6">
                    ...
                    <div class="p-3 sm:p-7">
                        <h6 class="text-gray-500 dark:text-dark-text leading-none font-semibold mb-6">Informasi Alamat</h6>
                        <form action="#" method="post">
                            <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                                ...
                                <div class="col-span-full">
                                    <label for="embedMap" class="form-label">Embed Map</label>
                                    <textarea id="embedMap" class="form-input h-48"></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card p-0 overflow-hidden mb-6">
                    <div class="p-3 sm:p-7">
                        <div class="flex justify-between items-center mb-6">
                            <h6 class="text-gray-500 dark:text-dark-text leading-none font-semibold">Informasi Kontak</h6>
                            <button type="button" class="btn btn-icon btn-sm btn-primary-light" onclick="addContactForm()">
                        ...
                        <form action="#" method="post">
                            <div id="contact-forms">
                                <div class="contact-form-group mb-4">
                                    <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                                        <div class="col-span-full xl:col-auto leading-none">
                                            <input type="text" placeholder="Nama Kontak" class="form-input">
                                        </div>
                                        <div class="col-span-full xl:col-auto leading-none">
                                            <input type="text" placeholder="Nilai Kontak" class="form-input">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex gap-3 mt-5">
                                ...
                                <button type="reset" class="btn b-light btn-danger-light dk-theme-card-square"
                                    data-modal-target="cancelAcSettingModal" data-modal-toggle="cancelAcSettingModal">
                ...
                <div class="bg-white dark:bg-dark-card rounded-15 overflow-hidden dk-theme-card-square">
                    ...
                    <div class="mt-7 px-6 text-center">
                        <div class="py-5">
                            ...
                            <p class="font-spline_sans leading-[1.62] text-heading dark:text-dark-text mt-2.5">Don’t Care
                                Everybody's Word🔥</p>
                            <p class="font-spline_sans text-sm leading-[1.62] text-gray-500 dark:text-dark-text mt-1">UI/IX
                                - Student at Academine👨🏻‍🎓</p>
                        </div>
                        ...
                        <div class="py-5 border-t border-gray-200 dark:border-dark-border text-left">
                            ...
                            <ul
                                ...
                                <li>
                                    ...
                                    <div>Lives in <span class="text-heading dark:text-dark-text">1901 Thornridge</span>
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="py-5 border-t border-gray-200 dark:border-dark-border text-left">
                            ...
                            <ul
                                ...
                                <li>
                                    ...
                                    <a href="#"
                                        class="hover:text-heading dark:hover:text-dark-text-two">Website.com</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <a href="#"
                                        class="hover:text-heading dark:hover:text-dark-text-two">LinkedIn</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div id="addBioModal" tabindex="-1"
        ...
        <div class="p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white dark:bg-dark-card-shade rounded-lg shadow">
                <button type="button" data-modal-hide="addBioModal"
    ...
    <div id="cancelAcSettingModal" tabindex="-1"
        class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-modal w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white dark:bg-dark-card-shade rounded-lg shadow">
                <button type="button" data-modal-hide="cancelAcSettingModal"
                    class="absolute top-3 end-2.5 hover:bg-gray-200 dark:hover:bg-dark-icon rounded-lg size-8 flex-center">
                    <i class="ri-close-line text-gray-500 dark:text-dark-text text-xl leading-none"></i>
                </button>
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button data-modal-hide="cancelAcSettingModal" type="button"
                        class="btn danger-btn-fill btn-sm hover:bg-red-600 inline-flex">
                        Yes, I'm sure
                    </button>
                </div>
            </div>
    ...
    <script>
        function addContactForm() {
            ...
            newForm.className = 'contact-form-group mb-4';
            newForm.innerHTML = `
                <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                    <div class="col-span-full xl:col-auto leading-none">
                        <input type="text" placeholder="Nama Kontak" class="form-input">
