                            ...
                            <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                                ...
                                <div class="flex col-span-full gap-x-4 w-100 w-full">
                                    <div class="w-full gap-x-4">
                                        ...
                                        <input type="text" id="slug" name="slug"
                                            value="{{ old('slug', $course->slug) }}" placeholder="Slug" class="form-input"
                                            required>
                                    </div>
                                    <div class="">
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <select class="singleSelect" name="categories_id">
                                        <option disabled {{ $course->categories_id ? '' : 'selected' }}>Pilih kategori
                                        </option>
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ $course->categories_id == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <select class="singleSelect" name="tingkatan">
                                        ...
                                        <option value="Beginner" {{ $course->tingkatan == 'Beginner' ? 'selected' : '' }}>
                                            Beginner</option>
                                        <option value="Intermediate"
                                            {{ $course->tingkatan == 'Intermediate' ? 'selected' : '' }}>Intermediate
                                        </option>
                                        <option value="Advanced" {{ $course->tingkatan == 'Advanced' ? 'selected' : '' }}>
                                            Advanced</option>
                                        <option value="Specialist"
                                            {{ $course->tingkatan == 'Specialist' ? 'selected' : '' }}>Specialist</option>
                                        <option value="Expert" {{ $course->tingkatan == 'Expert' ? 'selected' : '' }}>
                                            Expert</option>
                                        <option value="Professional"
                                            {{ $course->tingkatan == 'Professional' ? 'selected' : '' }}>Professional
                                        </option>
                                    </select>
                                </div>
                                <div class="col-span-full xl:col-auto leading-none">
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <select class="singleSelect" name="instruktur_id">
                                        ...
                                        @foreach ($instruktur as $ins)
                                            <option value="{{ $ins->id }}"
                                                {{ $course->instruktur_id == $ins->id ? 'selected' : '' }}>
                                                {{ $ins->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <select class="singleSelect" name="status">
                                        <option value="publik" {{ $course->status == 'publik' ? 'selected' : '' }}>Publik
                                        </option>
                                        <option value="draft" {{ $course->status == 'draft' ? 'selected' : '' }}>Draft
                                        </option>
                                        <option value="terjadwal" {{ $course->status == 'terjadwal' ? 'selected' : '' }}>
                                            Terjadwal</option>
                                    </select>
                                </div>
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <div id="berbayar" class="flex items-center gap-x-4" style="margin-top: 15px">
                                        <label class="flex items-center">
                                            <input type="radio" id="free" name="berbayar" value="false"
                                                {{ $course->berbayar == 'false' ? 'checked' : '' }} class="mr-2">
                                            Free
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" id="paid" name="berbayar" value="true"
                                                {{ $course->berbayar == 'true' ? 'checked' : '' }} class="mr-2">
                                            Paid
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    <div class="form-label" id="harga-group"
                                        style="display: {{ $course->berbayar == 'true' ? 'block' : 'none' }}">
                                ...
                                <div class="col-span-full xl:col-auto leading-none" id="harga-diskon-group"
                                    style="display: {{ $course->harga_diskon ? 'block' : 'none' }}">
                                    <label for="harga_diskon" class="mb-3 block font-semibold form-label">Discount
                                        Price</label>
