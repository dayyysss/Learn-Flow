...
<div class="main-content group-data-[sidebar-size=lg]:xl:ml-[calc(theme('spacing.app-menu')_+_16px)] group-data-[sidebar-size=sm]:xl:ml-[calc(theme('spacing.app-menu-sm')_+_16px)] group-data-[theme-width=box]:xl:px-0 px-3 xl:px-4 ac-transition">
    ...
    @csrf
        <div class="grid grid-cols-12 gap-x-4">
                    ...
                    <div class="mt-7  pt-0.5">
                        <div class="grid gap-y-5">
                            <div class="col-span-full xl:col-auto leading-none">
                                ...
                                <input type="text" id="name" name="name" placeholder="Nama" class="form-input @error('name') is-invalid @enderror" value="{{ old('name') }}">
                                        @error('name')
                            ...
                            <div>
                              ...
                              <div class="grid mt-3 gap-y-5">
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <input type="text" id="url" name="url" placeholder="Masukan URL" class="form-input " value="{{ old('url') }}">
                                </div>
                            </div>
            ...
            <div class="col-span-full lg:col-span-5 gap-y-3">
                <div class="card">
                <div class="p-1.5">
