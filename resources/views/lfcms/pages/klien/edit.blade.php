            ...
            <div class="col-span-full lg:col-span-7 card h-auto">
                <div class="p-1.5">
                    <div class="flex justify-between items-center gap-5">
                        <!-- Bagian Kiri -->
                        <a href="/lfcms/klien" class="flex items-center gap-1">
                    ...
                    <div class="mt-7  pt-0.5">
                        <div class="grid gap-y-5">
                            <div class="col-span-full xl:col-auto leading-none">
                                ...
                                <input type="text" id="name" name="name" placeholder="Nama" class="form-input @error('name') is-invalid @enderror" value="{{ old('name', $client->name) }}">
                                        @error('name')
                            ...
                            <div>
                              ...
                              <div class="grid mt-3 gap-y-5">
                                <div class="col-span-full xl:col-auto leading-none">
                                    ...
                                    <input type="text" id="url" name="url" placeholder="Masukan URL" class="form-input " value="{{ old('url', $client->url) }}">
                                </div>
                            </div>
                ...
                <div class="p-1.5">
                    ...
                    <div class="flex-1 w-full">
                                ...
                                <div class="file-container text-xs leading-none font-semibold mt-7 mb-3 cursor-pointer aspect-[3/2] flex items-center gap-2.5 dk-border-one border-dashed rounded-10 w-full">
                                        @if($client->image)
                                            <div>
                                                <img src="{{ asset('storage/' . $client->image) }}" alt="Gambar Testimoni" class="w-20 h-20 object-cover ">
                                            </div>
