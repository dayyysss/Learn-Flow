    ...
    <form action="https://template.codexshaper.com/admin/dashkit/all-course.html">
        <div class="grid grid-cols-12 gap-x-4">
            ...
            <div class="col-span-full h-fit lg:col-span-5 gap-y-3">
                <div class="card">
                    <div class="p-1.5">
                        <h6 class="card-title">Add Other</h6>
                        <div class="mt-7 pt-0.5 flex flex-col gap-5">
                            <div class="col-span-full xl:col-auto leading-none">
                                <label class="form-label">Status</label>
                                <select class="singleSelect">
                                    <option selected disabled>Select Label</option>
                                    <option value="val">Publik</option>
                                    <option value="val">Draft</option>
                                    <option value="val">Terjadwal</option>
                                </select>
                            </div>
                            <div class="col-span-full xl:col-auto leading-none">
                                <label class="form-label"><Article></Article> category</label>
                                <select class="singleSelect">
                                    <option selected disabled>Select category</option>
                            ...
                            <div class="col-span-full xl:col-auto leading-none">
                                <label for="deskripsi-singkat" class="form-label">Tag</label>
                    ...
                    <div class="p-1.5">
                        ...
                        <div class="mt-7 pt-0.5 flex flex-col gap-5">
                            <div class="col-span-full sm:col-span-4">
                                <p class="text-xs text-gray-500 dark:text-dark-text leading-none font-semibold mb-3">Thumbnail</p>
                                <label for="thumbnailsrc" class="file-container ac-bg text-xs leading-none font-semibold mb-3 cursor-pointer aspect-[4/3] flex flex-col items-center justify-center gap-2.5 border border-dashed border-gray-900 dark:border-dark-border rounded-10 dk-theme-card-square">
