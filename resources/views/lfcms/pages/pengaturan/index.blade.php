...
@section('page_title', 'Pengaturan | Learn Flow CMS')
@section('content')
    <div
                    ...
                    <div class="p-3 sm:p-7">
                        <form action="#" method="post">
                            <div class="grid grid-cols-2 gap-x-4 gap-y-5">
                                ...
                                <div class="col-span-full xl:col-auto leading-none">
                                    <label for="location" class="form-label">Negara</label>
                                    <select class="form-input form-select w-full singleSelect select2-hidden-accessible"
                                        data-select2-id="select2-data-1-hbrm" tabindex="-1" aria-hidden="true">
                                        <option value="create-a-new" data-select2-id="select2-data-3-72zb">Create a New
                                        </option>
                                        <option value="details-here" data-select2-id="select2-data-10-djed">Details Here
                                        </option>
