                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                            @foreach ($history as $item)
                                <tr
                                    ...
                                    <td class="px-7 py-6">{{ \Carbon\Carbon::parse($item->order_date)->format('d-m-Y') }}
                                    </td>
                                    ...
                                    <td class="px-7 py-6">
                                        <div class="relative">
                                            <button data-popover-target="payHistory1" data-popover-trigger="click"
                                                data-popover-placement="bottom-end"
                                                class="size-7 rounded-50 flex-center hover:bg-gray-200 dark:hover:bg-dark-icon">
                                                <i class="ri-more-2-fill text-inherit"></i>
                                            </button>
                                            <ul id="payHistory1" class="hidden popover-target invisible [&.visible]:!block"
                                                data-popover>
                                                <li>
