    ...
    <div
        ...
        <div class="flex flex-col md:flex-row gap-5">
                                ...
                                <form id="deleteForm-{{ $type->id }}"
                                    ...
                                    <div id="deleteContainer-{{ $type->id }}" style="display:inline;">
                                        <button type="button" class="btn-sm btn-danger delete-button"
                                            ...
                                            <i
                                                class="ri-delete-bin-line text-inherit text-[13px] {{ in_array($type->id, [1, 2]) ? 'hidden' : 'block' }}"></i>
                                        </button>
            ...
            <div class="bg-white md:w-7/12 w-full rounded dark:bg-dark-card-two shadow-lg p-4">
                <div
                    class="flex flex-col md:flex-row justify-between flex-wrap-reverse mb-5 md:items-center items-end gap-3">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button class="btn b-light btn-primary-light dk-theme-card-square" id="saveOrder"
                            style="display: none;">
                        ...
                        <button class="btn b-light btn-primary-light dk-theme-card-square" id="openModalMenuList">
                            <i class="btn ri-add-fill text-inherit"></i>
                            <span>Tambah</span>
                        </button>
                    </div>
            ...
            $('#saveOrder').click(function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        alert('Terjadi kesalahan saat menyimpan urutan menu: ' + xhr
                            .responseText);
                    }
                });
            });
