  ...
  <div id="addMenuListModal" class="modal-back" style="display: none">
    <div class="modal-content">
        ...
        <form action="{{ route('menu.store') }}" method="POST" class="space-y-4">
            ...
            <div class="mb-3">
                <label for="name" class="form-label text-sm font-medium text-gray-700">Nama</label>
                <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="name" name="name" >
            </div>

            <div class="mb-3">
                <label for="url" class="form-label text-sm font-medium text-gray-700">URL</label>
                <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="url" name="url" >
            </div>

            <div class="mb-3">
                <label for="ikon" class="text-sm font-medium text-gray-700">Ikon</label>
                <div class="flex items-center">
                    <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 sm:text-sm" id="ikon" name="ikon">
            ...
            <div class="mb-3">
                ...
                <select name="menutype_id" id="menutype_id" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" required>
            ...
            <div class="mb-3 permissions" id="permissions-container">
                ...
                <div class="flex flex-wrap space-x-4">
                    ...
                    <label id="create-permission"><input type="checkbox" name="permissions[]" value="create"> Create</label>
...
<div class="modal-content">
  ...
  <h3>Edit Tipe Menu</h3>
      ...
      @method('PUT') <!-- Gunakan PUT untuk update -->
          ...
          <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="edit_name" name="name" required>
              </div>
      <div class="modal-footer">
          <button type="submit" class="btn bg-indigo-700">Simpan</button>
              </div>
    ...
    <div class="modal-content">
        ...
        <form action="" method="POST" class="space-y-4" id="editMenuListForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="edit_nama" name="name" required>
            </div>
            
            <!-- URL -->
            <div class="mb-3">
                <label for="edit_url" class="form-label text-sm font-medium text-gray-700">URL</label>
                <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="edit_url" name="url">
            </div>

            <!-- Ikon -->
            <div class="mb-3">
                <label for="edit_ikon" class="form-label text-sm font-medium text-gray-700">Ikon</label>
                <input type="text" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm" id="edit_ikon" name="ikon">
            </div>

            <!-- Menu Type -->
            <div class="mb-3">
                <label for="edit_menutype_id" class="form-label text-sm font-medium text-gray-700">Menu Type</label>
                <select id="edit_menutype_id" name="menutype_id" class="form-control mt-1 block w-full border border-slate-400 rounded-md shadow-sm p-2 sm:text-sm">
...
.modal-footer {
  ...
  <script>
    ...
    $('#ikon').iconpicker(); // Inisialisasi pada input dengan id 'ikon'
});

  </script>
  <script>
    $(document).ready(function() {
    $('#edit_ikon').iconpicker(); // Inisialisasi pada input dengan id 'ikon'
});
