...
@section('page_title', 'Detail Blog | Learn Flow')
@section('content')

    @include('landing.components.breadcrumb', ['title' => 'Detail Blog'])
                ...
                <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
                    ...
                    <div data-aos="fade-up">
                        ...
                        <div class="overflow-hidden relative mb-30px">
                            <img src="assets/images/blog/blog_21.png" alt="" class="w-full">
                        </div>
                        <!-- blog content -->
                        <div>
                            ...
                            <p class="text-lg text-darkdeep4 mb-30px !leading-30px" data-aos="fade-up">
                                We have covered many special events such as fireworks,
                                fairs, parades, races, walks, awards ceremonies, fashion
                                shows, sporting events, and even a memorial service.
                            </p>
                            <p class="text-lg text-darkdeep4 mb-35px !leading-30px" data-aos="fade-up">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Curabitur vulputate vestibulum Phasellus rhoncus, dolor eget
                                viverra pretium, dolor tellus aliquet nunc, vitae ultricies
                                erat elit eu lacus. Vestibulum non justo consectetur, cursus
                            ...
                            <div class="pt-55px pr-10 pb-60px pl-70px xs:p-5 sm:pt-55px sm:pr-10 sm:pb-60px sm:pl-70px mb-43px bg-blackColor2 dark:bg-blackColor2-dark text-whiteColor dark:text-whiteColor-dark font-medium relative"
                                data-aos="fade-up">
                                <h5
                                ...
                                <a href="#"
                                    class="text-size-17 leading-23px relative pl-60px before:w-45px before:h-0.5 before:bg-whiteColor dark:before:bg-whiteColor-dark before:absolute before:left-0 before:top-2/4">John
                                    Mirnsdo</a>
                                <div class="absolute left-[22%] top-[22%] md:left-[37%] md:top-[14%]" data-aos="fade-up">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-30px mb-50px">
                                <!-- about left -->
                                <div class="md:col-start-1 md:col-span-4 relative" data-aos="fade-up">
                                    <div>
                                        <img class="w-full" src="assets/images/blog/blog_23.png" alt="">
                                    </div>
                                    <div
                                ...
                                <!-- video right -->
                                <div data-aos="fade-up" class="md:col-start-5 md:col-span-8">
                                    <h4 class="text-2xl font-bold text-blackColor dark:text-blackColor-dark mb-15px !leading-30px"
                                        data-aos="fade-up">
                                    ...
                                    <ul class="space-y-3">
                                        <li class="flex items-center group">
                                            <i
                                                class="icofont-check px-0.5 py-2 text-primaryColor bg-whitegrey3 bg-opacity-40 group-hover:bg-primaryColor group-hover:text-white group-hover:opacity-100 mr-15px dark:bg-whitegrey1-dark"></i>
                                            <p
                                ...
                                <ul>
                                    <li class="flex gap-30px mb-10">
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img src="assets/images/blog-details/blog-details__1.png" alt=""
                                    ...
                                    <li class="flex gap-30px mb-10 lg:pl-100px">
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img src="assets/images/blog-details/blog-details__2.png" alt=""
                                                    class="w-20 h-20 rounded-full">
                                            </div>
                                        </div>
                                        <div class="flex-grow">
                                    ...
                                    <li class="flex gap-30px mb-10">
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img src="assets/images/blog-details/blog-details__3.png" alt=""
                                                    class="w-20 h-20 rounded-full">
                                            </div>
                                        </div>
                                        <div class="flex-grow">
                                    ...
                                    <li class="flex gap-30px mb-10 lg:pl-100px">
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img src="assets/images/blog-details/blog-details__4.png" alt=""
                                                    class="w-20 h-20 rounded-full">
                                            </div>
                                        </div>
                                        <div class="flex-grow">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="p-5 md:p-30px lg:p-5 2xl:p-30px mb-30px border border-borderColor2 dark:border-borderColor2-dark text-center"
                            ...
                            <div class="mb-3">
                                <h3 class="mb-7px">
                                    <a href="#"
                                        class="text-xl font-bold text-blackColor2 dark:text-blackColor2-dark">Rosalina
                                        D. Willaim</a>
                                </h3>
