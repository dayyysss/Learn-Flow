...
@section('page_title', 'Detail Zoom & Webinars | Learn Flow')
@section('content')

    @include('landing.components.breadcrumb', ['title' => 'Detail Zoom & Webinars'])
    <!--meeting details section -->
    <section>
        <div class="container py-10 md:py-50px lg:py-60px 2xl:py-100px">
            <!-- meeting thumbnail -->
            <div class="overflow-hidden relative mb-50px">
                <img src="../../assets/images/zoom/details.jpg" alt="" class="w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-30px">
                <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
                    <div data-aos="fade-up">
                        <!--meeting content -->
                        <div class="space-y-5">
                            <p class="text-sm 2xl:text-lg text-darkdeep4 !leading-30px" data-aos="fade-up">
                            ...
                            <ul class="space-y-[15px]">
                                ...
                                <li class="flex items-center group ">
                                    ...
                                    <p
                                        class="text-sm lg:text-xs 2xl:text-sm font-medium leading-25px lg:leading-21px 2xl:leading-25px max-w-[508px] text-contentColor dark:text-contentColor-dark">
                ...
                <div class="lg:col-start-9 lg:col-span-4">
                    <div>
                        <!-- enroll section -->
                        <div class="py-33px px-25px shadow-event mb-30px bg-whiteColor dark:bg-whiteColor-dark"
                            data-aos="fade-up">
                            ...
                            <ul>
                                <li
                                    class="flex items-center mb-4.5 pb-4.5 border-b border-borderColor dark:border-borderColor-dark">
                                    <div>
                                        <i
                                            class="icofont-teacher text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Instructor:</p>
                                        <a class="font-bold text-contentColor hover:text-secondaryColor dark:text-contentColor-dark dark:hover:text-secondaryColor"
                                            href="../../instructor-details.html">D. Willaim</a>
                                    </div>
                                </li>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-clock-time text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Time:</p>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-calendar text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Date:</p>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-document-folder text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Time Zone:</p>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-learn text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Enrolled:</p>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-globe-alt text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Language:</p>
                                ...
                                <li
                                    ...
                                    <div>
                                        <i
                                            class="icofont-certificate text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"></i>
                                    </div>
                                    <div
                                        class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark">
                                        <p>Certificate:</p>
