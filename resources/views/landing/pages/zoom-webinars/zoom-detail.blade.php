        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-30px">
          ...
          <div class="lg:col-start-9 lg:col-span-4">
            <div>
              <!-- enroll section -->
              <div
                class="py-33px px-25px shadow-event mb-30px bg-whiteColor dark:bg-whiteColor-dark"
                data-aos="fade-up"
              >
                ...
                <ul>
                  ...
                  >
                    <div>
                      <i
                        class="icofont-teacher text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                    ...
                    >
                      <p>Instructor:</p>
                      <a
                        class="font-bold text-contentColor hover:text-secondaryColor dark:text-contentColor-dark dark:hover:text-secondaryColor"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-clock-time text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-calendar text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-document-folder text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-learn text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-globe-alt text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
                  ...
                  >
                    <div>
                      <i
                        class="icofont-certificate text-size-22 mr-10px text-blackColor dark:text-blackColor-dark"
                      ></i>
                    </div>
                    <div
                      class="flex-grow flex justify-between items-center text-blackColor dark:text-blackColor-dark"
