...
@include('landing.components.breadcrumb', ['title' => 'Zoom & Webinars'])
    ...
    <section>
      <div
        class="container-fluid-2 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-30px pt-100px pb-100px"
        data-aos="fade-up"
      >
        <!-- card 1 -->
        <div class="group" data-aos="fade-up">
          <div>
            ...
            >
              ...
              <div>
                <div
                  class="flex flex-wrap justify-between items-center mb-15px"
                >
                ...
                <a
                  href="zoom-meeting-details.html"
                ...
                <!-- time -->
                <p
                  class="text-sm text-contentColor dark:text-contentColor-dark flex items-center"
                >
                  Starting Time:
                  <span
                ...
                <!-- time -->
                <p
                  class="text-sm text-contentColor dark:text-contentColor-dark flex items-center mb-15px"
                >
                  Meeting ID :
                  <span
                    class="text-sm md:text-lg leading-9 md:leading-12 font-bold text-secondaryColor ml-10px"
                    >952428993999</span
                  >
                </p>
                <!-- author and rating-->
                <div class="pt-15px border-t border-borderColor">
                  <div>
                    <a
                      ...
                      class="text-xs flex items-center text-contentColor hover:text-primaryColor dark:text-contentColor-dark dark:hover:text-primaryColor"
                      ><img
                      ...
                      <div>
                        <span>Speaker:</span>
                        <h3
                          class="text-lg font-bold text-blackColor dark:text-blackColor-dark"
                        >
                          Mirnsdo .H
                        </h3>
                      </div>
