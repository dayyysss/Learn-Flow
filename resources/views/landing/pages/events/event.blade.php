    ...
    <div class="container py-50px md:py-70px lg:py-20 2xl:py-100px">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-30px">
        <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
          ...
          <div>
            ...
            <div class="flex flex-wrap items-center">
              <div
                class="flex mr-26px md:mr-76px items-center"
                data-aos="fade-up"
              >
        ...
        <div class="lg:col-start-9 lg:col-span-4">
          ...
          >
            <h4
              class="text-size-21 text-blackColor dark:text-blackColor-dark font-bold leading-25px"
            >
              Sopnsored
            </h4>
            <div class="mt-25px mb-30px">
              <img
                src="assets/images/icon/event__details__2.png"
                alt=""
              >
            </div>
            <p
              class="text-contentColor dark:text-contentColor-dark font-semibold leading-19px mb-15px"
            >
              Thomas R. Toe
            </p>
            <p
              class="text-sm text-contentColor dark:text-contentColor-dark font-medium leading-[17px]"
            >
            ...
            <div>
              <ul class="flex gap-10px items-center mt-5">
                ...
                <li>
                  <a
                    href="#"
                    class="w-10 h-9 leading-9 text-center text-skycolor bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor dark:bg-whitegrey2-dark dark:text-skycolor dark:hover:text-whiteColor dark:hover:bg-primaryColor rounded"
                ...
                <li>
                  <a
                    href="#"
                    class="w-10 h-9 leading-9 text-center text-deepred bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor dark:bg-whitegrey2-dark dark:text-deepred dark:hover:text-whiteColor dark:hover:bg-primaryColor rounded"
