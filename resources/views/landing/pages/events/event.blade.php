...
@section('page_title', 'Event Details | Learn Flow')
@section('content')

    @include('landing.components.breadcrumb', ['title' => 'Event Details'])
    <section>
        <div class="container py-50px md:py-70px lg:py-20 2xl:py-100px">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-30px">
                <div class="lg:col-start-1 lg:col-span-8 space-y-[35px]">
                    <!-- event heading -->
                    <div>
                        <p class="text-sm text-whiteColor bg-indigo rounded leading-25px px-2 mb-30px inline-block"
                            data-aos="fade-up">
                            Mechanical
                        </p>
                        <h3 class="text-3xl md:text-size-40 leading-11 md:leading-13.5 text-blackColor dark:text-blackColor-dark mb-15px font-bold"
                            data-aos="fade-up">
                            Become a product manager learn the Skills & job.
                        </h3>
                        <div class="flex flex-wrap items-center">
                            <div class="flex mr-26px md:mr-76px items-center" data-aos="fade-up">
                                <div class="flex-shrink-0 w-66px h-66px">
                                    <img src="assets/images/event/event__5.png" alt="">
                                </div>
                                <div>
                                    <p
                                        class="text-base md:text-size-11 lg:text-base font-medium text-blackColor dark:text-blackColor-dark leading-19px">
                                        Teacher:
                                    </p>
                                    <p
                                        class="text-sm md:text-xs lg:text-sm text-contentColor dark:text-contentColor-dark leading-4 mb-15px">
                                        Elon Masksd
                                    </p>
                                </div>
                            </div>
                            <div class="mr-26px md:mr-76px" data-aos="fade-up">
                                <div>
                                    <p
                                        class="text-base md:text-size-11 lg:text-base font-medium text-blackColor dark:text-blackColor-dark leading-19px">
                                        Last Update:
                    ...
                    <div data-aos="fade-up" class="mt-35px mb-30px">
                        ...
                        <div class="overflow-hidden relative mb-35px">
                            <img src="assets/images/event/event__6.png" alt="" class="w-full">
                        </div>
                        <!-- blog content -->
                        <div>
                            <h4 class="text-size-26 font-bold text-blackColor dark:text-blackColor-dark mb-15px !leading-30px"
                                data-aos="fade-up">
                                Description
                            </h4>
                            <p class="text-darkdeep4 mb-15px !leading-29px" data-aos="fade-up">
                            ...
                            <ul data-aos="fade-up">
                                <li>
                                    <p class="text-contentColor dark:text-contentColor-dark mb-10px !leading-29px">
                                ...
                                <li>
                                    <p class="text-contentColor dark:text-contentColor-dark mb-10px !leading-29px">
                                        <i class="icofont-check text-primaryColor"></i> Anyone
                ...
                <div class="lg:col-start-9 lg:col-span-4">
                    <!-- enroll section -->
                    <div class="py-33px px-25px shadow-event mb-30px" data-aos="fade-up">
                        ...
                        <ul>
                            <li
                                class="flex items-center gap-x-10px mb-25px pb-22px border-b border-borderColor dark:border-borderColor-dark">
                                <div>
                    ...
                    <!-- sponsored section -->
                    <div class="py-33px px-25px shadow-event mb-30px" data-aos="fade-up">
                        <h4 class="text-size-21 text-blackColor dark:text-blackColor-dark font-bold leading-25px">
                            Sopnsored
                        </h4>
                        <div class="mt-25px mb-30px">
                            <img src="assets/images/icon/event__details__2.png" alt="">
                        </div>
                        <p class="text-contentColor dark:text-contentColor-dark font-semibold leading-19px mb-15px">
                            Thomas R. Toe
                        </p>
                        <p class="text-sm text-contentColor dark:text-contentColor-dark font-medium leading-[17px]">
                        ...
                        <div>
                            <ul class="flex gap-10px items-center mt-5">
                                <li>
                                    <p
                                        class="text-xl font-semibold text-contentColor dark:text-contentColor-dark leading-6">
                                        Share:
                                    </p>
                                </li>
                                <li>
                                    <a href="#"
                                        class="w-10 h-9 leading-9 text-center text-skycolor bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor dark:bg-whitegrey2-dark dark:text-skycolor dark:hover:text-whiteColor dark:hover:bg-primaryColor rounded"><i
                                ...
                                <li>
                                    <a href="#"
                                        class="w-10 h-9 leading-9 text-center text-deepred bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor dark:bg-whitegrey2-dark dark:text-deepred dark:hover:text-whiteColor dark:hover:bg-primaryColor rounded"><i
