                                ...
                                @auth
                                    ...
                                    <li class="relative px-1 lg:px-10px 2xl:px-1 lg:py-1 2xl:py-1px 3xl:py-1 group">
                                        <div class="mr-5 cursor-pointer group relative flex items-center">
                                            ...
                                            <!-- Profile Dropdown -->
                                            <div class="dropdown-profile absolute top-full right-0 mt-2 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-300 z-50 bg-white dark:bg-darkblack-dark rounded-lg shadow-md p-5">
