                ...
                <div class="mb-30px lg:mb-0 pb-0 md:pb-30px xl:pb-0 lg:col-start-1 lg:col-span-7" data-aos="fade-up">
                    <div class="relative">
                        ...
                        <h3
                            ...
                            Daftarkan
                            <span
                                class="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-2 md:after:bottom-4 z-0 after:z-[-1]">Akun</span>
                            Anda Dapatkan akses gratis ke
                            <span class="text-yellow1">60000 </span> kursus online
                        </h3>
                        <div class="flex gap-x-5 items-center">
                            ...
                            <div>
                                <p
                                    ...
                                    Pelajari Sesuatu yang baru & Bangun Karir Anda Dari Mana Saja Di Dunia
                                </p>
                            </div>
                        </div>
                    </div>
