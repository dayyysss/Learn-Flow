<div data-aos="fade-up">
    <div
        ...
        <div class="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px">
            <a href="#"><img src="assets/images/brand/brand_1.png" alt=""></a>
        </div>
        <div class="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px">
            <a href="#">
                <img src="assets/images/brand/brand_2.png" alt=""></a>
        </div>
        <div class="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px">
            <a href="#">
                <img src="assets/images/brand/brand_3.png" alt=""></a>
        </div>
        <div class="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px">
            <a href="#">
                <img src="assets/images/brand/brand_4.png" alt=""></a>
        </div>
        <div class="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px">
            <a href="#">
                <img src="assets/images/brand/brand_5.png" alt=""></a>
        </div>
    </div>
</div>
