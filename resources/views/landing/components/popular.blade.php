                        ...
                        <div class="md:translate-y-[30px]">
                            <div
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-sm lg:text-xs 2xl:text-sm text-contentColor group-hover:text-whiteColor mb-15px lg:mb-2 2xl:mb-15px transition-all duration-300">
                                        Pelajari teknik desain terbaru dan cara untuk menerapkannya dalam pekerjaan
                                        kreatif.
                                    </p>
                                    <div>
                                        <div
                                            class="text-sm text-black dark:text-blackColor-darkColor group-hover:text-whiteColor dark:text-blackColor-dark dark:group-hover:text-whiteColor-dark">
                                            <a href="#"
                                                class="text-sm font-medium hover:text-secondaryColor transition-all duration-300">Lihat
                                                Kursus
                                                <i class="icofont-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                    ...
                    <div data-aos="fade-up">
                        <div
                            ...
                            <div>
                                ...
                                <p
                                    class="text-sm lg:text-xs 2xl:text-sm text-contentColor group-hover:text-whiteColor mb-15px lg:mb-2 2xl:mb-15px transition-all duration-300">
                                    Pahami dasar-dasar dan penerapan pembelajaran mesin dalam berbagai sektor industri.
                                </p>
                                <div>
                                    <div
                                        class="text-sm text-black dark:text-blackColor-darkColor group-hover:text-whiteColor dark:text-blackColor-dark dark:group-hover:text-whiteColor-dark">
                                        <a href="#"
                                            class="text-sm font-medium hover:text-secondaryColor transition-none">Lihat
                                            Kursus
                                            <i class="icofont-long-arrow-right"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="md:translate-y-[30px]">
                            <div
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-sm lg:text-xs 2xl:text-sm text-contentColor group-hover:text-whiteColor mb-15px lg:mb-2 2xl:mb-15px transition-all duration-300">
                                        Pelajari konsep-konsep dasar serta penerapan teknologi dalam dunia nyata.
                                    </p>
                                    <div>
                                        <div
                                            class="text-sm text-black dark:text-blackColor-darkColor group-hover:text-whiteColor dark:text-blackColor-dark dark:group-hover:text-whiteColor-dark">
