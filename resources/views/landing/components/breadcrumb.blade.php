        ...
        <div class="container">
            <div class="text-center">
                ...
                <ul class="flex gap-1 justify-center">
                    <li>
                        <a href="{{ url('/') }}" class="text-lg text-blackColor2 dark:text-blackColor2-dark">Home
                            <i class="icofont-simple-right"></i></a>
                    </li>
                    <li>
                        <span class="text-lg text-blackColor2 dark:text-blackColor2-dark">{{ $title ?? 'Page' }}</span>
                    </li>
                </ul>
            </div>
        </div>
